...
export const metadata: Metadata = {
  title: "Baking with Barbs - Handcrafted Baked Goods",
  description: "Fresh homemade cookies, cupcakes, brownies & more. Order delicious handcrafted baked goods today. DM for custom orders.",
  keywords: "baking, homemade cookies, cupcakes, brownies, handcrafted baked goods, order online",
  openGraph: {
    title: "Baking with Barbs - Homemade Baked Goods",
    description: "Discover delicious handcrafted baked goods. Fresh cookies, cupcakes, and more made with love.",
    siteName: "Baking with Barbs",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Baking with Barbs",
    description: "Handcrafted baked goods made fresh daily. Order now!"
  },
  robots: {
    index: true,
    follow: true
